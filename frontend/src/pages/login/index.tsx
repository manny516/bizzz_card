...
<<<<<<< HEAD
                            <input placeholder="Username" className="w-full h-14 bg-gray-200 rounded-xl" type="text" name="username" value="" />
                        </article> 

                        <article className="mb-4">
                            <input placeholder="Password" className="w-full h-14 bg-gray-200 rounded-xl" type="password" name="password" value="" />
                        </article>
                        
                        <input id="sign-up" type="submit" name="signup" className="p-2 h-12 text-center border-none cursor-pointer bg-violet-800 w-full text-white rounded-lg mt-4 hover:bg-zinc-800" value="Login" />
=======
